...
##################################################################################################
##################################################################################################
directory<-"/media/somics/Data/mRNA/2/Aug15/DiffExp/39Samples_Jan16/counts/"
...
write.csv(godTX_sig, "godTX_sig.csv")
...
write.csv(ortho_bmdTX_Diet_sig, "ortho_bmdTX_diet_sig.csv")
...
write.csv(bmdTX_Diet, "bmdTX_Diet_sig.csv")
...
write.csv(godF1_sig, "godF1_sig.csv")
...
write.csv(ortho_bmdF1_Diet_sig, "ortho_bmdF1_diet_sig.csv")
...
write.csv(bmdF1_Diet, "bmdF1_Diet_sig.csv")
...
write.csv(godFS_TX_sig, "godFS_TX_sig.csv")
...
write.csv(ortho_bmdFS_TX_sig, "ortho_bmdFS_TX_sig.csv")
...
write.csv(bmdFS_TX, "bmdFS_TX_sig.csv")
...
write.csv(godFS_F1_sig, "godFS_F1_sig.csv")
...
write.csv(ortho_bmdFS_F1_sig, "ortho_bmdFS_F1_sig.csv")
sortbmdFS_TX_sig<-cbind(bmdFS_TX_sig[match(rndFS_TX_sig, bmdFS_TX_sig$ensembl_gene_id),])
...
write.csv(bmdFS_F1, "bmdFS_F1_sig.csv")
...
write.csv(godTX_F1_sig, "godTX_F1_sig.csv")
...
write.csv(ortho_bmdTX_F1_sig, "ortho_bmdTX_F1_sig.csv")
...
write.csv(bmdTX_F1, "bmdTX_F1_sig.csv")
...
write.csv(gocFS_TX_sig, "gocFS_TX_sig.csv")
...
write.csv(ortho_bmcFS_TX_sig, "ortho_bmcFS_TX_sig.csv")
...
write.csv(bmcFS_TX, "bmcFS_TX_sig.csv")
...
write.csv(gofFS_TX_sig, "gofFS_TX_sig.csv")
...
write.csv(ortho_bmfFS_TX_sig, "ortho_bmfFS_TX_sig.csv")
...
write.csv(bmfFS_TX, "bmfFS_TX_sig.csv")
...
write.csv(gocFS_F1_sig, "gocFS_F1_sig.csv")
...
write.csv(ortho_bmcFS_F1_sig, "ortho_bmcFS_F1_sig.csv")
...
write.csv(bmcFS_F1, "bmcFS_F1_sig.csv")
...
write.csv(gofFS_F1_sig, "gofFS_F1_sig.csv")
...
write.csv(ortho_bmfFS_F1_sig, "ortho_bmfFS_F1_sig.csv")
...
write.csv(bmfFS_F1, "bmfFS_F1_sig.csv")
...
write.csv(gocTX_F1_sig, "gocTX_F1_sig.csv")
...
write.csv(ortho_bmcTX_F1_sig, "ortho_bmcTX_F1_sig.csv")
...
write.csv(bmcTX_F1, "bmcTX_F1_sig.csv")
...
write.csv(gofTX_F1_sig, "gofTX_F1_sig.csv")
...
write.csv(ortho_bmfTX_F1_sig, "ortho_bmfTX_F1_sig.csv")
...
write.csv(bmfTX_F1, "bmfTX_F1_sig.csv")
...
write.csv(all_rn, "all_rownames.csv")
...
write.csv((bm_all_de_entrez), "bm_all_de_entrez.csv")
