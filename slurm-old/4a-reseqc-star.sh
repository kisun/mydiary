#!/bin/bash -l
#SBATCH -J rseqc-star
#SBATCH -o out_rseqc-star_%A_%a.txt
#SBATCH -e err_rseqc-star_%A_%a.txt
#SBATCH -t 08:00:00
#SBATCH -n 1
#SBATCH --array=1-42
...
outdir="/wrk/kipokh/DONOTREMOVE/Data/projects/mRNA/cl-end/results/rseqc-star"
dir="/wrk/kipokh/DONOTREMOVE/Data/projects/mRNA/cl-end/results/star/"

cd $dir
bam=$(ls *Aligned.sorted* | sed -n "$SLURM_ARRAY_TASK_ID"p)
